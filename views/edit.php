...
<div class="container py-5">
    <div class="row justify-content-center">
        <div class="col-lg-8 col-xl-7">
            ...
            <h2 class="epic-form-title text-center mb-4">Edit Game</h2>

            <form action="index.php?action=update&id=<?= $gameData['gameId'] ?>" 
                  method="POST" 
                ...
                <div class="mb-4">
                    ...
                    <input type="text" 
                           name="gameName" 
                           value="<?= htmlspecialchars($gameData['gameName']) ?>" 
                ...
                <div class="mb-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" 
                               name="gamePrice" 
                               value="<?= htmlspecialchars($gameData['gamePrice']) ?>" 
                               class="form-control epic-input" 
                    ...
                    <small class="epic-helper-text">Update the game price in USD</small>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <small class="epic-helper-text">Leave empty to keep current image. Recommended: 3:4 aspect ratio</small>
                    
                    <div class="epic-preview-container">
                        <img id="imagePreview" 
                             src="uploads/<?= htmlspecialchars($gameData['gameImage'] ?: 'default.png') ?>" 
                ...
                <div class="d-flex gap-3 mt-4">
                    <button type="submit" class="btn btn-epic-update flex-fill">
...
function previewImage(event) {
    ...
    if(event.target.files.length > 0) {
        ...
        preview.src = "uploads/<?= htmlspecialchars($gameData['gameImage'] ?: 'default.png') ?>";
    }
}
</script>
